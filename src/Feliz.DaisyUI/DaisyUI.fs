...
type Daisy =
    ...
    static member inline alert children = Helpers.Elm.children Html.div children "alert"
    ...
    static member inline artboard children = Helpers.Elm.children Html.div children "artboard"
    ...
    static member inline avatar children = Helpers.Elm.children Html.div children "avatar"
    ...
    static member inline avatarGroup children = Helpers.Elm.children Html.div children "avatar-group"
    ...
    static member inline badge children = Helpers.Elm.children Html.div children "badge"
    ...
    static member inline breadcrumbs children = Helpers.Elm.children Html.div children "breadcrumbs"
    ...
    static member inline buttonGroup children = Helpers.Elm.children Html.div children "btn-group"
    ...
    static member inline card children = Helpers.Elm.children Html.div children "card"
    ...
    static member inline cardTitle children = Helpers.Elm.children Html.h2 children "card-title"
    ...
    static member inline cardBody children = Helpers.Elm.children Html.div children "card-body"
    ...
    static member inline cardActions children = Helpers.Elm.children Html.div children "card-actions"
    ...
    static member inline carousel children = Helpers.Elm.children Html.div children "carousel"
    ...
    static member inline carouselItem children = Helpers.Elm.children Html.div children "carousel-item"
    ...
    static member inline collapse children = Helpers.Elm.children Html.div children "collapse"
    ...
    static member inline collapseTitle children = Helpers.Elm.children Html.div children "collapse-title"
    ...
    static member inline collapseContent children = Helpers.Elm.children Html.div children "collapse-content"
    ...
    static member inline countdown children = Helpers.Elm.children Html.span children "countdown"
    ...
    static member inline divider children = Helpers.Elm.children Html.div children "divider"
    ...
    static member inline drawer children = Helpers.Elm.children Html.div children "drawer"
    ...
    static member inline drawerContent children = Helpers.Elm.children Html.div children "drawer-content"
    ...
    static member inline drawerSide children = Helpers.Elm.children Html.div children "drawer-side"
    ...
    static member inline dropdown children = Helpers.Elm.children Html.div children "dropdown"
    ...
    static member inline dropdownContent children = Helpers.Elm.children Html.ul children "dropdown-content"
    ...
    static member inline footer children = Helpers.Elm.children Html.footer children "footer"
    ...
    static member inline footerTitle children = Helpers.Elm.children Html.span children "footer-title"
    ...
    static member inline hero children = Helpers.Elm.children Html.div children "hero"
    ...
    static member inline heroContent children = Helpers.Elm.children Html.div children "hero-content"
    ...
    static member inline heroOverlay children = Helpers.Elm.children Html.div children "hero-overlay"
    ...
    static member inline indicator children = Helpers.Elm.children Html.div children "indicator"
    ...
    static member inline indicatorItem children = Helpers.Elm.children Html.div children "indicator-item"
    ...
    static member inline kbd children = Helpers.Elm.children Html.kbd children "kbd"
    ...
    static member inline link children = Helpers.Elm.children Html.a children "link"
...
//    static member inline mask children = Helpers.Elm.children Html.div children "mask"
//    static member inline mask elm = Helpers.Elm.elm Html.div elm "mask"
    ...
    static member inline menu children = Helpers.Elm.children Html.ul children "menu"
    ...
    static member inline menuTitle children = Helpers.Elm.children Html.li children "menu-title"
    ...
    static member inline modal children = Helpers.Elm.children Html.div children "modal"
    ...
    static member inline modalBox children = Helpers.Elm.children Html.div children "modal-box"
    ...
    static member inline modalAction children = Helpers.Elm.children Html.div children "modal-action"
    ...
    static member inline modalButton children = Helpers.Elm.children Html.label children "btn modal-button"
    ...
    static member inline navbar children = Helpers.Elm.children Html.div children "navbar"
    ...
    static member inline navbarStart children = Helpers.Elm.children Html.div children "navbar-start"
    ...
    static member inline navbarCenter children = Helpers.Elm.children Html.div children "navbar-center"
    ...
    static member inline navbarEnd children = Helpers.Elm.children Html.div children "navbar-end"
    ...
    static member inline progress children = Helpers.Elm.children Html.progress children "progress"
    ...
    static member inline stack children = Helpers.Elm.children Html.div children "stack"
    ...
    static member inline stats children = Helpers.Elm.children Html.div children "stats"
    ...
    static member inline stat children = Helpers.Elm.children Html.div children "stat"
    ...
    static member inline statTitle children = Helpers.Elm.children Html.div children "stat-title"
    ...
    static member inline statValue children = Helpers.Elm.children Html.div children "stat-value"
    ...
    static member inline statDesc children = Helpers.Elm.children Html.div children "stat-desc"
    ...
    static member inline statFigure children = Helpers.Elm.children Html.div children "stat-figure"
    ...
    static member inline steps children = Helpers.Elm.children Html.ul children "steps"
    ...
    static member inline step children = Helpers.Elm.children Html.li children "step"
    ...
    static member inline tabs children = Helpers.Elm.children Html.div children "tabs"
    ...
    static member inline tab children = Helpers.Elm.children Html.a children "tab"
    ...
    static member inline table children = Helpers.Elm.children Html.table children "table"
    ...
    static member inline tooltip children = Helpers.Elm.children Html.div children "tooltip"
    ...
    static member inline formControl children = Helpers.Elm.children Html.div children "form-control"
    ...
    static member inline label children = Helpers.Elm.children Html.label children "label"
    ...
    static member inline labelText children = Helpers.Elm.children Html.span children "label-text"
    ...
    static member inline labelTextAlt children = Helpers.Elm.children Html.span children "label-text-alt"
    ...
    static member inline inputGroup children = Helpers.Elm.children Html.div children "input-group"
    ...
    static member inline select children = Helpers.Elm.children Html.select children "select"
    ...
    static member inline textarea children = Helpers.Elm.children Html.textarea children "textarea"
    ...
    static member inline mockupCode children = Helpers.Elm.children Html.div children "mockup-code"
    ...
    static member inline mockupPhone children = Helpers.Elm.children Html.div children "mockup-phone"
    ...
    static member inline mockupPhoneCamera children = Helpers.Elm.children Html.div children "camera"
    ...
    static member inline mockupPhoneDisplay children = Helpers.Elm.children Html.div children "display"
    ...
    static member inline mockupWindow children = Helpers.Elm.children Html.div children "mockup-window"
...
module Daisy =
    ...
    type button =
        ...
        static member inline button children = Helpers.Elm.children Html.button children "btn"
        ...
        static member inline a children = Helpers.Elm.children Html.a children "btn"
